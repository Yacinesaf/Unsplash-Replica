...
import { getImageById } from '../reduxStore/actions'
import RelatedCollection from './RelatedCollection';

class PhotoMobilePage extends Component {

  componentDidMount() {
    const id = this.props.location.split('/')
    console.log("PhotoMobilePage -> componentDidMount -> id", id)
  ...
  render() {
    return (
      <Grid container justify='center'>
        ...
        <Grid item xs={11}>
          <Typography style={{ color: 'darkgrey', paddingBottom: 20 }}>Related collections</Typography>
...
export default connect(mapStateToProps, { getImageById })(PhotoMobilePage)